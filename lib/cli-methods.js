...
module.exports.download = function(theme_address, zip_only){
  ...
  var url = "https://"+domain+"/api/v2/themes/"+theme_id+"/theme/download?key="+api_key;
...
module.exports.list = function(domain){
  ...
  var url = "https://"+domain+"/api/v2/themes?key="+api_key;
...
module.exports.status = function(status_type){
  ...
  var url = "https://"+config.theme.domain+"/api/v2/"
    + "themes/"
    + config.theme.id
    + "/theme/"
    + status_type
...
module.exports.sync = function(direction){
  ...
  */
  ...
  if(direction == "up"){
    ...
    //First, sync the theme.json
    module.exports.pushTheme();
