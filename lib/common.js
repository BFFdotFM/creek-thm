...
-------------------------------------
 ...
 Needs the user's settings file:

 ~/.creek-themes/settings.json
...
var _ = require('underscore'),
  ...
  settings = require('./user-settings').get(),
  settings_methods = require('./user-settings')
...
exports.val = exports.getValueSafe;
...
exports.writeLastRemoteErrorPage = function(data){
  ...
  var error_file_path = path.join(settings_methods.getSettingsDir(), "last-remote-error.html");

  fs.writeFile(error_file_path, data, function(err) {
    if(err) {
      exports.c("Error page failed to write.");
      exports.c(err);
    } else {
      exports.c("Error written to error page: "+error_file_path);
    }
  });
...
exports.directoryExists = exports.dirExists;
