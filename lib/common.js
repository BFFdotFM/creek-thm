...
exports.getJSONfromResponse = function(response_body){
  ...
  if(response_body !== null && typeof response_body === 'object')
    ...
    try{
      ...
      exports.writeLastErrorPage(response_body)
      // c.o()
    }
  }
...
exports.writeLastErrorPage = function(data){

  fs.writeFile("last-error.html", data, function(err) {
    if(err) {
        exports.c(err);
    } else {
        exports.c("Written to error page.");
    }
  });
